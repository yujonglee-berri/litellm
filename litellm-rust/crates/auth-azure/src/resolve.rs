...
use litellm_auth::{
    AuthError, CredentialFileRef, CredentialLookup, CredentialRef, InputSource, ResolvedCredential,
    ...
    fn request_oidc_reference_is_rejected_before_lookup() {
        ...
        assert!(matches!(
            ...
            AuthError::Configuration(
                litellm_auth::error::AuthConfigurationError::RequestAzureCredentialReference
            )
        ));
    }
